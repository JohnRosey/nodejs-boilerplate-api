...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Odie.Brekke89',
      password: 'hdrVYePaVSl1MEC',
      email: 'Thaddeus.Rippin72@gmail.com',
      name: 'Barry Nitzsche',
      userType: 942,
      mobileNo: '(288) 376-3925',
      resetPasswordLink: {},
      loginRetryLimit: 596,
      loginReactiveTime: '2024-07-04T07:35:20.887Z',
      id: '658a6baba02cee3931578e0c'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Gaetano.Harber45',
        'password':'kG42avzioHYvZ2Y',
        'email':'Rylee.Schroeder32@gmail.com',
        'name':'Harvey Cruickshank',
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'(066) 014-1512',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Rylee.Schroeder32@gmail.com', });
